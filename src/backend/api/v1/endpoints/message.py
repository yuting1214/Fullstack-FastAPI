...
async def get_message(message_id: str, service: MessageService = Depends()):
...
async def update_message(message_id: str, message_data: MessageBase, service: MessageService = Depends()):
...
async def delete_message(message_id: str, service: MessageService = Depends()):
